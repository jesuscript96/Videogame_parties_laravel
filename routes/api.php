...
Route::group([
    ...
    Route::post('/parties/newuser', [partyController::class, 'addUserToParty']);
    ...
    Route::get('/messages/party/{id}', [messageController::class, 'getMessagesFromParty']);
});
...
Route::group([
    'middleware' => ['jwt.auth', 'isUser']
], function () {
    // USER CRUD
    Route::put('/users/update/{id}', [userController::class, 'updateUsersById']);
